...
class User extends \User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'User' . "\0" . 'id', '' . "\0" . 'User' . "\0" . 'nom_complet', '' . "\0" . 'User' . "\0" . 'avatar', '' . "\0" . 'User' . "\0" . 'telephone', '' . "\0" . 'User' . "\0" . 'email', '' . "\0" . 'User' . "\0" . 'adresse', '' . "\0" . 'User' . "\0" . 'login', '' . "\0" . 'User' . "\0" . 'password', '' . "\0" . 'User' . "\0" . 'profil', '' . "\0" . 'User' . "\0" . 'offres', '' . "\0" . 'User' . "\0" . 'reponses'];
        }
    ...
    public function getNom_complet()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNom_complet', []);

        return parent::getNom_complet();
    }
    ...
    public function setNom_complet($nom_complet)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNom_complet', [$nom_complet]);

        return parent::setNom_complet($nom_complet);
    }
    ...
    public function setReponses($reponses)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReponses', [$reponses]);
