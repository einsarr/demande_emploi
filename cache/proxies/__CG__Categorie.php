 ...
 */
class Categorie extends \Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Categorie' . "\0" . 'id', '' . "\0" . 'Categorie' . "\0" . 'libelle', '' . "\0" . 'Categorie' . "\0" . 'description', '' . "\0" . 'Categorie' . "\0" . 'offres'];
        }
